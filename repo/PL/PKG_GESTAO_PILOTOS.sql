-----------Registra o piloto------------
CREATE OR REPLACE PROCEDURE pr_registrar_piloto(
...
CREATE OR REPLACE PROCEDURE pr_registrar_substituicao(
...
CREATE OR REPLACE FUNCTION fn_pontuacao_campeonato(
