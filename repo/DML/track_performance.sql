...
SELECT TIMESTAMP '2024-03-24 15:00:00' + NUMTODSINTERVAL(v.numero_volta, 'MINUTE') + NUMTODSINTERVAL(s.amostra, 'SECOND'),
       ...
       GREATEST(0, 100 - s.amostra * 0.8 + DBMS_RANDOM.VALUE(0, 3)),
...
INSERT INTO Telemetria SELECT TIMESTAMP '2024-03-24 15:00:00' + NUMTODSINTERVAL(v.numero_volta, 'MINUTE') + NUMTODSINTERVAL(s.amostra, 'SECOND'),
       v.numero_volta, 'Corrida', 'Grand Prix da Austrália', 2024, v.credencial_FIA_piloto,
       (88 + v.numero_volta * 0.25 + DBMS_RANDOM.VALUE(0, 1)), (21 + DBMS_RANDOM.VALUE(0, 1)), GREATEST(0, 100 - s.amostra * 0.7 + DBMS_RANDOM.VALUE(0, 2)),
...
INSERT INTO Telemetria SELECT TIMESTAMP '2024-03-24 15:00:00' + NUMTODSINTERVAL(v.numero_volta, 'MINUTE') + NUMTODSINTERVAL(s.amostra, 'SECOND'),
       v.numero_volta, 'Corrida', 'Grand Prix da Austrália', 2024, v.credencial_FIA_piloto,
       (89 + v.numero_volta * 0.28 + DBMS_RANDOM.VALUE(0, 2)), (21 + DBMS_RANDOM.VALUE(0, 1.5)), GREATEST(0, 100 - s.amostra * 0.75 + DBMS_RANDOM.VALUE(0, 2)),
...
INSERT INTO Telemetria SELECT TIMESTAMP '2024-03-24 15:00:00' + NUMTODSINTERVAL(v.numero_volta, 'MINUTE') + NUMTODSINTERVAL(s.amostra, 'SECOND'),
       v.numero_volta, 'Corrida', 'Grand Prix da Austrália', 2024, v.credencial_FIA_piloto,
       (90 + v.numero_volta * 0.35 + DBMS_RANDOM.VALUE(0, 3)), (21 + DBMS_RANDOM.VALUE(0, 2)), GREATEST(0, 100 - s.amostra * 0.9 + DBMS_RANDOM.VALUE(0, 3)),
