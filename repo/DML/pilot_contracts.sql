...
INSERT INTO Contrato (nome_equipe_patrocinada, LEI_patrocinador, data_inicio, data_fim, valor)
VALUES ('Scuderia Ferrari', 'RE8900006M94867W22V11', DATE '2024-01-01', DATE '2026-12-31', 120000000);

INSERT INTO Contrato (nome_equipe_patrocinada, LEI_patrocinador, data_inicio, data_fim, valor)
VALUES ('Mercedes-AMG Petronas', 'PET770006M94867W22V33', DATE '2024-01-01', DATE '2026-12-31', 100000000);

INSERT INTO Contrato (nome_equipe_patrocinada, LEI_patrocinador, data_inicio, data_fim, valor)
VALUES ('Scuderia Ferrari', 'ARAMCO006M94867W22V55', DATE '2024-01-01', DATE '2026-12-31', 80000000);
...
INSERT INTO Patrocina (LEI_patrocinador, credencial_FIA_piloto, data_inicio, data_fim, valor)
VALUES ('RE8900006M94867W22V11', '1001', DATE '2024-01-01', DATE '2026-12-31', 4000000);  -- Hamilton-Santander

INSERT INTO Patrocina (LEI_patrocinador, credencial_FIA_piloto, data_inicio, data_fim, valor)
VALUES ('RE8900006M94867W22V11', '1002', DATE '2024-01-01', DATE '2026-12-31', 3000000);  -- Leclerc-Santander

INSERT INTO Patrocina (LEI_patrocinador, credencial_FIA_piloto, data_inicio, data_fim, valor)
VALUES ('ARAMCO006M94867W22V55', '1002', DATE '2024-01-01', DATE '2026-12-31', 2500000);  -- Leclerc-Aramco

INSERT INTO Patrocina (LEI_patrocinador, credencial_FIA_piloto, data_inicio, data_fim, valor)
VALUES ('AWS110006M94867W22V99', '1003', DATE '2024-01-01', DATE '2026-12-31', 3500000);  -- Norris-AWS

-- 4. ENTIDADE: Substitui (Substituição de Pilotos)

INSERT INTO Substitui (tipo_sessao, nome_gp, ano_gp, credencial_FIA_piloto_substituido, credencial_FIA_piloto_substituto, motivo_substituicao)
VALUES ('Qualificação', 'Grand Prix da Austrália', 2024, '1000', '1003', 'Injury');
